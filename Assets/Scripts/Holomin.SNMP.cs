...
{
	List<Dictionary<string, string>> Devices = null;
	// List<Dictionary<string, string>> SNMP = null;

	void GetMacAddresses(string SwitchIp = "192.168.1.222")
	{
		// List<Dictionary<string, string>> Devices = new List<Dictionary<string, string>>();
		Devices = new List<Dictionary<string, string>>();
		...
		foreach (var item in result)
		{
			...
			//Debug.Log(System.Convert.ToString(item));
	...
	private List<Dictionary<string, string>> GetMacAddressesV2(string SwitchIp)
	{
		// List<Dictionary<string, string>> Devices = new List<Dictionary<string, string>>();
		Devices = new List<Dictionary<string, string>>();
